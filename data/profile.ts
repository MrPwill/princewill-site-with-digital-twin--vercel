  ...
  experience: [
    {
      ...
      period: "2024 - Present",
      highlights: [
        "Built 5 production-grade AI applications: Slate PM, ClauseGuard Africa, AI SDR Platform, Digital Twin Agent, and Synthetic Data Generator",
    ...
    },
    {
      ...
      highlights: [
        "Designed and deployed autonomous AI agents for financial monitoring, reporting, and operational automation",
        "Built RAG-powered AI knowledge systems to answer business queries from internal documents",
        "Developed agentic workflows using n8n to automate CRM updates, reporting pipelines, and stakeholder notifications",
        "Implemented voice AI agents using ElevenLabs for customer interaction and internal process automation",
        "Integrated LLMs with Google Sheets, APIs, and messaging platforms to eliminate manual workflows",
      ],
    },
    {
      id: "exp-2",
      ...
      highlights: [
        "Built and deployed machine learning models for business forecasting and analytics",
        "Developed ETL pipelines using Python and SQL to process large datasets",
        "Created dashboards and reports for executive decision-making",
        "Conducted model evaluation and optimization for improved performance",
      ],
    },
    {
      id: "exp-3",
    ...
    },
    {
      ...
      highlights: [
        "Reconciled the bank's general ledger entries with correspondent banks' records",
        "Prepared comprehensive reconciliation reports on MS Excel",
        "Conducted Anti-Money Laundering (AML) audits of branches, compliance units, ORM, and MRM groups",
        "Rendered regulatory returns to CBN and NFIU",
        "Reviewed compliance returns for completeness, timeliness, and accuracy",
      ],
    },
  ],
  education: [
